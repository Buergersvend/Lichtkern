...
import { auth, db, fsGet, fsSet, fsDelete, onAuthStateChanged, signOut, createUserWithEmailAndPassword, signInWithEmailAndPassword } from "./src/config/firebase.js";
import { groqFetch } from "./src/config/groq.js";
...
const SIDEBAR_SECTIONS = [
  ...
  { label: "Resonanz", items: [
    ...
    { id: "resonanz-raeume", label: "Resonanz-Räume", icon: "✧" },
