        ...
        <OCard style={{background:OT.bgSoft,border:`1.5px solid ${OT.borderMid}`}}>
          ...
          {kiLaed ? (
            ...
            <>
              ...
              {/* RASTER-1C-KASTEN — Hinweis entfaellt, wenn die Eingangssperre gegriffen hat:
                  der Pflichtsatz steht dann bereits im Text darueber. */}
              {!enthältKrankheitsbegriff(eingabe) && (
