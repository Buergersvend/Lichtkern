...
function History({sessions, onDelete}){
  ...
  if(detail)return(<div style={{padding:"0 16px 96px"}}>
    ...
    {detail.homework&&<div style={{marginBottom:"10px",background:"rgba(201,168,76,0.08)",borderRadius:"16px",padding:"16px",border:`1.5px solid rgba(201,168,76,0.3)`}}><SL color={T.goldD}>🌱 Integrationsauftrag</SL><div style={{fontFamily:"Raleway",fontSize:"14px",color:T.text,lineHeight:"1.75",fontWeight:500}}>{detail.homework}</div></div>}
