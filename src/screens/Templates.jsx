...
const DEFAULT_TEMPLATES = [
  {
    ...
    techniques:["Energetische Bestandsaufnahme","Belastungstest","Muster-Check","Chakren-Balance"],
    goal:"Erstgespräch & Kennenlernen des Energiesystems",
  ...
  {
    id:"tpl_energy", name:"Seelisch-symbolische Tiefenarbeit", emoji:"⚡", builtin:true,
    type:"followup", category:"Bewusstsein", resonanceSource:"innerer Impuls",
    levels:{energetisch:80,spirituell:70,universell:60},
    techniques:["Chakren-Balance","Meridian-Ausgleich","innere Klärung","Schutz & Stärkung","Heilige Geometrie"],
    goal:"innere Klärung und Stärkung auf seelisch-symbolischer Ebene",
