          ...
          {days.map(d=>{
            ...
            return(
              <div key={d} onClick={()=>{setCurrent(d);}} style={{minHeight:"52px",borderRadius:"10px",padding:"3px",cursor:"pointer",background:isSelected?"rgba(168,125,58,0.2)":isToday?"rgba(168,125,58,0.1)":"transparent",border:isSelected?`1.5px solid ${T.borderMid}`:"1.5px solid transparent",opacity:isThisMonth?1:0.35}}>
                <div style={{fontFamily:"Raleway",fontSize:"11px",fontWeight:isToday?800:600,color:isToday?T.gold:"rgba(245,240,232,0.85)",marginBottom:"3px",textAlign:"center",width:"22px",height:"22px",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 3px",background:isToday?T.goldL:"transparent"}}>{pd.getDate()}</div>
