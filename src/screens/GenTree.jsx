        ...
        <Card style={{marginBottom:"12px"}}>
          ...
          {relations.map(r=>{
            ...
            return(
             ...
             <button onClick={e=>{e.stopPropagation();deleteRelation(r.id);}} title="Löschen" style={{fontFamily:"Raleway",fontSize:"11px",color:"#C0392B",background:T.bgCard,border:"1px solid #C0392B",borderRadius:"8px",padding:"4px 9px",cursor:"pointer",fontWeight:700}}>✕</button>
              </div>
            );
          })}
        </Card>
