      ...
      {relations.length>0&&(
        <Card style={{marginBottom:"12px"}}>
          ...
          {relations.map(r=>{
            ...
            <button onClick={e=>{e.stopPropagation();deleteRelation(r.id);}} title="Löschen" style={{fontFamily:"Raleway",fontSize:"10px",color:"#C0392B",background:T.bgCard,border:"1px solid #C0392B",borderRadius:"8px",padding:"4px 10px",cursor:"pointer",fontWeight:700,letterSpacing:"0.5px"}}>Entfernen</button>
              </div>
            );
          })}
        </Card>
