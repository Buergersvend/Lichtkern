      ...
      <div style={{ background: T.bgCard, borderRadius: '20px', width: '100%', maxWidth: '680px', maxHeight: '90vh', overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
        ...
        {!karteText && !loading && (
          <div style={{ padding: '60px 32px', textAlign: 'center' }}>
            ...
            <div style={{ fontFamily: 'Raleway', fontSize: '13px', color: T.textMid, lineHeight: '1.7', maxWidth: '420px', margin: '0 auto 24px' }}>
              Die KI schreibt einen persönlichen Brief für {client.name} — eine warmherzige Synthese aus Human Design und Numerologie, die du ausdrucken und deinem Klienten mitgeben kannst.
            </div>
        ...
        {karteText && !loading && (
          <div ref={printRef}>
            ...
            {/* PAGE 1 */}
            <div className="rk-page" style={{ width: '210mm', minHeight: '297mm', margin: '0 auto', padding: '26mm 28mm 18mm', background: '#0D0D0A', color: '#F5F0E8', position: 'relative', overflow: 'hidden' }}>
              ...
              <div style={{ position: 'absolute', bottom: '12mm', left: '28mm', right: '28mm', textAlign: 'center' }}>
            ...
            {/* PAGE 2 */}
            <div className="rk-page" style={{ width: '210mm', minHeight: '297mm', margin: '0 auto', padding: '22mm 28mm 18mm', background: '#0D0D0A', color: '#F5F0E8', position: 'relative' }}>
