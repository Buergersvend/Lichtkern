...
function TreeOfLife({size=320,opacity=0.13,color}){
  const c=color||T.teal;
  return(
    <svg width={size} height={size} style={{position:"absolute",bottom:0,right:-20,opacity,pointerEvents:"none"}} viewBox="0 0 200 220">
      {/* Roots */}
      <path d="M100 200 Q85 185 70 195" fill="none" stroke={c} strokeWidth="2.5" strokeLinecap="round"/>
      <path d="M100 200 Q100 182 100 210" fill="none" stroke={c} strokeWidth="2.5" strokeLinecap="round"/>
      <path d="M100 200 Q115 185 130 195" fill="none" stroke={c} strokeWidth="2.5" strokeLinecap="round"/>
      <path d="M100 200 Q80 180 60 188" fill="none" stroke={c} strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M100 200 Q120 180 140 188" fill="none" stroke={c} strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M90 198 Q75 192 65 200" fill="none" stroke={c} strokeWidth="1" strokeLinecap="round"/>
      <path d="M110 198 Q125 192 135 200" fill="none" stroke={c} strokeWidth="1" strokeLinecap="round"/>
      {/* Trunk */}
      <path d="M100 200 Q96 175 98 150 Q100 130 100 110" fill="none" stroke={c} strokeWidth="5" strokeLinecap="round"/>
      {/* Main branches */}
      <path d="M100 150 Q80 135 60 130" fill="none" stroke={c} strokeWidth="3" strokeLinecap="round"/>
      <path d="M100 150 Q120 135 140 130" fill="none" stroke={c} strokeWidth="3" strokeLinecap="round"/>
      <path d="M100 130 Q75 110 50 105" fill="none" stroke={c} strokeWidth="2.5" strokeLinecap="round"/>
      <path d="M100 130 Q125 110 150 105" fill="none" stroke={c} strokeWidth="2.5" strokeLinecap="round"/>
      <path d="M100 115 Q85 95 70 85" fill="none" stroke={c} strokeWidth="2" strokeLinecap="round"/>
      <path d="M100 115 Q115 95 130 85" fill="none" stroke={c} strokeWidth="2" strokeLinecap="round"/>
      {/* Upper branches */}
      <path d="M100 110 Q90 88 80 70" fill="none" stroke={c} strokeWidth="1.8" strokeLinecap="round"/>
      <path d="M100 110 Q110 88 120 70" fill="none" stroke={c} strokeWidth="1.8" strokeLinecap="round"/>
      <path d="M100 110 Q100 85 100 65" fill="none" stroke={c} strokeWidth="2" strokeLinecap="round"/>
      {/* Twigs */}
      <path d="M60 130 Q52 120 45 118" fill="none" stroke={c} strokeWidth="1.2" strokeLinecap="round"/>
      <path d="M60 130 Q55 122 58 115" fill="none" stroke={c} strokeWidth="1.2" strokeLinecap="round"/>
      <path d="M140 130 Q148 120 155 118" fill="none" stroke={c} strokeWidth="1.2" strokeLinecap="round"/>
      <path d="M140 130 Q145 122 142 115" fill="none" stroke={c} strokeWidth="1.2" strokeLinecap="round"/>
      <path d="M50 105 Q42 95 36 92" fill="none" stroke={c} strokeWidth="1" strokeLinecap="round"/>
      <path d="M50 105 Q46 96 50 90" fill="none" stroke={c} strokeWidth="1" strokeLinecap="round"/>
      <path d="M150 105 Q158 95 164 92" fill="none" stroke={c} strokeWidth="1" strokeLinecap="round"/>
      <path d="M70 85 Q62 76 58 70" fill="none" stroke={c} strokeWidth="1" strokeLinecap="round"/>
      <path d="M70 85 Q68 75 72 70" fill="none" stroke={c} strokeWidth="1" strokeLinecap="round"/>
      <path d="M130 85 Q138 76 142 70" fill="none" stroke={c} strokeWidth="1" strokeLinecap="round"/>
      <path d="M80 70 Q75 60 72 54" fill="none" stroke={c} strokeWidth="1" strokeLinecap="round"/>
      <path d="M80 70 Q82 60 86 55" fill="none" stroke={c} strokeWidth="1" strokeLinecap="round"/>
      <path d="M120 70 Q125 60 128 54" fill="none" stroke={c} strokeWidth="1" strokeLinecap="round"/>
      <path d="M100 65 Q95 52 92 44" fill="none" stroke={c} strokeWidth="1.2" strokeLinecap="round"/>
      <path d="M100 65 Q105 52 108 44" fill="none" stroke={c} strokeWidth="1.2" strokeLinecap="round"/>
      <path d="M100 65 Q100 50 100 40" fill="none" stroke={c} strokeWidth="1.5" strokeLinecap="round"/>
      {/* Leaf dots */}
      {[[45,116],[58,113],[36,90],[50,88],[155,116],[142,113],[164,90],[58,68],[72,68],[86,53],[92,42],[100,38],[108,42],[128,52],[142,68]].map(([x,y],i)=>(
        <circle key={i} cx={x} cy={y} r="3.5" fill={c} opacity="0.7"/>
      ))}
      {[[44,108],[60,108],[35,82],[52,82],[156,108],[143,108],[165,82],[56,62],[74,62],[88,47],[94,36],[100,32],[106,36],[130,46],[144,62]].map(([x,y],i)=>(
        <circle key={`s${i}`} cx={x} cy={y} r="2" fill={c} opacity="0.4"/>
      ))}
    </svg>
  );
}
  ...
  return(
    <div style={{padding:"0 16px 100px"}}>
      ...
      <div style={{position:"relative",borderRadius:"24px",overflow:"hidden",padding:"24px 22px 22px",marginBottom:"16px",background:`linear-gradient(145deg,${T.tealL} 0%,#FAFFFE 55%,${T.violetL} 100%)`,boxShadow:`0 4px 24px rgba(13,148,136,0.18)`,border:`1.5px solid ${T.border}`}}>
        <Flower size={220} opacity={0.06}/>
        <TreeOfLife size={220} opacity={0.12}/>
      ...
      {clients.length===0&&(
        <div style={{background:"white",borderRadius:"20px",border:`1.5px dashed ${T.borderMid}`,padding:"32px 24px",textAlign:"center",marginBottom:"16px"}}>
          <div style={{fontSize:"40px",marginBottom:"12px"}}>🌱</div>
          <div style={{fontFamily:"Cinzel",fontSize:"16px",color:T.text,fontWeight:700,marginBottom:"6px"}}>Noch keine Klienten</div>
          <div style={{fontFamily:"Raleway",fontSize:"13px",color:T.textSoft,marginBottom:"20px",lineHeight:"1.5"}}>Leg deinen ersten Klienten an und starte mit Lichtkern.</div>
          <button onClick={()=>onNav("clients")} style={{fontFamily:"Raleway",fontWeight:700,fontSize:"13px",padding:"11px 24px",borderRadius:"16px",background:T.tealL,color:T.tealD,border:`1.5px solid ${T.borderMid}`,cursor:"pointer"}}>◈ Klient anlegen</button>
        </div>
      )}
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"10px",marginBottom:"16px"}}>
        {[
          {label:"Klient anlegen",   icon:"◈", s:"clients",   bg:"white",     border:T.borderMid,  c:T.tealD},
          {label:"Kalender",         icon:"⊡", s:"calendar",  bg:"white",     border:"#A78BFA",    c:T.violetD},
          {label:"Wissensbasis",     icon:"◆", s:"knowledge", bg:"white",     border:"#6BAEE8",    c:"#0A2A50"},
          {label:"Generationsbaum",  icon:"🧬",s:"gentree",   bg:"white",     border:"#9B7EE0",    c:"#2A1660"},
          {label:"Abrechnung",       icon:"◎", s:"billing",   bg:"white",     border:"#4ADE80",    c:"#0A3B20"},
          {label:"Analyse",          icon:"◇", s:"analytics", bg:"white",     border:T.borderMid,  c:T.tealD},
        ].map((a,i)=>(
          <div key={i} onClick={()=>onNav(a.s)} style={{background:a.bg,borderRadius:"18px",padding:"18px 16px",cursor:"pointer",border:`1.5px solid ${a.border}`,boxShadow:`0 2px 12px rgba(0,0,0,0.05)`,display:"flex",alignItems:"center",gap:"12px",transition:"transform 0.15s"}}>
            <div style={{width:"36px",height:"36px",borderRadius:"10px",background:a.border+"22",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"18px",flexShrink:0}}>{a.icon}</div>
...
function App({ user, onLogout }){
  ...
  return(<div style={{background:T.bg,minHeight:"100vh",maxWidth:"480px",margin:"0 auto",position:"relative"}}>
    ...
    <div style={{position:"relative",zIndex:1,paddingTop:"12px"}}>
      <header style={{padding:"12px 16px 10px",display:"flex",justifyContent:"space-between",alignItems:"flex-start",borderBottom:`1.5px solid ${T.border}`,marginBottom:"4px"}}>
        <div>
